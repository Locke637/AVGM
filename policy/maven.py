...
class MAVEN:
    def __init__(self, args):
        ...
        if self.args.load_model:
            if os.path.exists(self.model_dir + '/' + str(self.args.load_num) + '_rnn_net_params.pkl'):
                path_z_policy = self.model_dir + '/' + str(self.args.load_num) + '_z_policy_params.pkl'
                ...
                path_mi = self.model_dir + '/' + str(self.args.load_num) + '_mi_net_params.pkl'
    ...
    def learn(self, batch, max_episode_len, train_step, epsilon=None):  # train_step表示是第几次学习，用来控制更新target_net网络的参数
        ...
        # print(mi_prob.shape, class_z.shape)
        # print(s.shape)
        # print(inputs.shape)
        # -------------------------------------------------MI Loss------------------------------------------------------
        ...
        # loss = self.args.lambda_ql * ql_loss
    ...
    def init_hidden_test(self, episode_num, var_nums):
        # 为每个episode中的每个agent都初始化一个eval_hidden、target_hidden
        self.eval_hidden = torch.zeros((episode_num, var_nums, self.args.rnn_hidden_dim))
        self.target_hidden = torch.zeros((episode_num, var_nums, self.args.rnn_hidden_dim))
