...
class HierarchicalPolicyState(nn.Module):
    def __init__(self, args):
        super(HierarchicalPolicyState, self).__init__()
...
class HierarchicalPolicy(nn.Module):
    def __init__(self, args):
        ...
        self.fc_1 = nn.Linear(args.obs_shape, 128)
        self.fc_2 = nn.Linear(128, args.noise_dim)
...
class BootstrappedRNN(nn.Module):
    def __init__(self, input_shape, args):
        ...
        self.hyper_w = nn.Linear(args.noise_dim + args.n_agents + args.id_dim, args.rnn_hidden_dim * args.n_actions)
        self.hyper_b = nn.Linear(args.noise_dim + args.n_agents + args.id_dim, args.n_actions)
...
class VarDistributionState(nn.Module):
    def __init__(self, args):
        super(VarDistributionState, self).__init__()
        self.args = args

        # self.GRU = nn.GRU(args.state_shape, 64)
        self.fc_0 = nn.Linear(args.state_shape, 64)
...
class VarDistribution(nn.Module):
    def __init__(self, args):
        ...
        # self.GRU = nn.GRU(args.state_shape, 64)
        self.fc_0 = nn.Linear(args.obs_shape, 64)
